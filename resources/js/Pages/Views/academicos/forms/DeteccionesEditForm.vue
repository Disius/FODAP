...
const maxCount = [
    value => {
        if (value.length > 3) return "Solo pueden haber tres facilitadores"
            ...
            <v-container class="mt-5">
                ...
                <v-row justify="center">
                    ...
                    <v-col>
                        ...
                        <v-autocomplete :counter="3" multiple :items="props.docentes" item-title="nombre_completo" item-value="id"
