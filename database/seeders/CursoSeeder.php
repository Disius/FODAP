...
class CursoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $deteccion = DeteccionNecesidades::create([
            ...
            'aceptado' => 0,
            'obs' => 0,
            'total_horas' => CoursesController::total_horas("2023-10-27", "2023-11-05", "08:00", "14:00"),
            'modalidad' => 2,
        ...
        $deteccion3 = DeteccionNecesidades::create([
            ...
            'aceptado' => 0,
            'obs' => 0,
            'total_horas' => CoursesController::total_horas("2023-10-27", "2023-11-05", "09:00", "15:00"),
            'modalidad' => 2,
            'facilitador_externo' =>  null,
            'id_departamento' => 6
        ]);
        ...
        $deteccion4 = DeteccionNecesidades::create([
            ...
            'aceptado' => 0,
            'obs' => 0,
            'total_horas' => CoursesController::total_horas("2023-10-30", "2023-11-10", "09:00", "15:00"),
            'modalidad' => 2,
            'facilitador_externo' =>  null,
            'id_departamento' => 4
        ]);
        ...
        $deteccion4 = DeteccionNecesidades::create([
            ...
            'aceptado' => 0,
            'obs' => 0,
            'total_horas' => CoursesController::total_horas("2023-10-30", "2023-11-15", "09:00", "15:00"),
            'modalidad' => 2,
            'facilitador_externo' =>  null,
            'id_departamento' => 4
        ]);
        ...
        $deteccion6 = DeteccionNecesidades::create([
            ...
            'aceptado' => 1,
            'obs' => 0,
            'total_horas' => CoursesController::total_horas("2023-10-30", "2023-11-10", "08:00", "14:00"),
            'modalidad' => 2,
            'facilitador_externo' =>  null,
            'id_departamento' => 9
        ]);
        ...
        $deteccion8 = DeteccionNecesidades::create([
            ...
            'aceptado' => 1,
            'obs' => 0,
            'total_horas' => CoursesController::total_horas("2023-10-31", "2023-11-25", "09:00", "15:00"),
            'modalidad' => 2,
            'facilitador_externo' =>  null,
            'id_departamento' => 7
        ]);
        ...
        $deteccion10 = DeteccionNecesidades::create([
            ...
            'aceptado' => 1,
            'obs' => 0,
            'total_horas' => CoursesController::total_horas("2023-11-23", "2023-11-27", "09:00", "15:00"),
            'modalidad' => 2,
            'facilitador_externo' =>  null,
            'id_departamento' => 7
        ]);
